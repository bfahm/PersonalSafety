...
namespace PersonalSafety.Services
{
    public interface IAccountBusiness
    {
        ...
        Task<APIResponse<bool>> SendConfirmMailAsync(string email, bool isOTPRequired);
        Task<APIResponse<bool>> ConfirmMailAsync(ConfirmMailViewModel request, bool isOTPRequired);
    }
}
